#include "WARRootListController.h"

@implementation WARRootListController
	...
	-(void) sendEmail{
		[[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"mailto:merlino.giuseppe1@gmail.com?subject=WAReply"]];
	}
@end
